...
process.source = cms.Source("PoolSource",
        ...
        "/store/group/phys_higgs/cmshgg/ferriff/flashgg/RunIISpring16DR80X-2_2_0-25ns_ICHEP16_MiniAODv2_regression/2_2_0/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/RunIISpring16DR80X-2_2_0-25ns_ICHEP16_MiniAODv2_regression-2_2_0-v1-RunIISpring16MiniAODv2-PUSpring16_80X_mcRun2_asymptotic_2016_miniAODv2_v0-v1/160803_134918/0000/myMicroAODOutputFile_1.root"
        ))
...
process.flashggUpdatedIdMVADiPhotons.correctionFile = cms.FileInPath("flashgg/MicroAOD/data/transformation_80X_v4_mod.root")
process.flashggUpdatedIdMVADiPhotons.non5x5correctionFile = cms.FileInPath("flashgg/MicroAOD/data/transformation_Ichep16_non5x5.root")
print process.flashggUpdatedIdMVADiPhotons.src
print process.flashggUpdatedIdMVADiPhotons.correctionFile
print process.flashggUpdatedIdMVADiPhotons.non5x5correctionFile
