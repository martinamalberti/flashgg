...
myvariables = [ "mass       := diPhoton().mass", 
                ...
                "lead_seedE      := diPhoton().leadingPhoton.seedEnergy()", #seed cluster energy
                "subLead_seedE   := diPhoton().subLeadingPhoton.seedEnergy()", # seed cluster energy
                "lead_eMax       := diPhoton().leadingPhoton.eMax", # max crystal energy
                "subLead_eMax    := diPhoton().subLeadingPhoton.eMax", # max crystal energy
                "lead_kHasSwitchToGain6    := diPhoton().leadingPhoton.checkStatusFlag('kHasSwitchToGain6')",
                "subLead_kHasSwitchToGain6 := diPhoton().subLeadingPhoton.checkStatusFlag('kHasSwitchToGain6')",
                "lead_kHasSwitchToGain1    := diPhoton().leadingPhoton.checkStatusFlag('kHasSwitchToGain1')",
                "subLead_kHasSwitchToGain1 := diPhoton().subLeadingPhoton.checkStatusFlag('kHasSwitchToGain1')",
                ]
...
customize.setDefault("targetLumi",1.0e+3)
