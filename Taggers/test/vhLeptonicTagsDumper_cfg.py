...
leptons_variables = [ "mu1_pt         :=  ? muons.size()>0 ? muons[0].pt() : -100 ",
                      "mu1_phi        :=  ? muons.size()>0 ? muons[0].eta() : -100 ",
                      "mu1_eta        :=  ? muons.size()>0 ? muons[0].phi() : -100 ",
                      "mu2_pt         :=  ? muons.size()>1 ? muons[1].pt() : -100 ",
                      "mu2_ph1        :=  ? muons.size()>1 ? muons[1].eta() : -100 ",
                      "mu2_eta        :=  ? muons.size()>1 ? muons[1].phi() : -100 ",
                      "ele1_pt        :=  ? electrons.size()>0 ? electrons[0].pt() : -100 ",
                      "ele1_phi       :=  ? electrons.size()>0 ? electrons[0].eta() : -100 ",
                      "ele1_eta       :=  ? electrons.size()>0 ? electrons[0].phi() : -100 ",
                      "ele2_pt        :=  ? electrons.size()>1 ? electrons[1].pt() : -100 ",
                      "ele2_phi       :=  ? electrons.size()>1 ? electrons[1].eta() : -100 ",
                      "ele2_eta       :=  ? electrons.size()>1 ? electrons[1].phi() : -100 "
                     ]

jets_variables = ["njets := jets.size()",
                  "jet1_pt     :=  ? jets.size()>0 ? jets[0].pt : -100 ",
                  "jet1_phi    :=  ? jets.size()>0 ? jets[0].eta : -100 ",
                  "jet1_eta    :=  ? jets.size()>0 ? jets[0].phi : -100 ",
                  "jet2_pt     :=  ? jets.size()>1 ? jets[1].pt : -100 ",
                  "jet2_phi    :=  ? jets.size()>1 ? jets[1].eta : -100 ",
                  "jet2_eta    :=  ? jets.size()>1 ? jets[1].phi : -100 ",
                  "jet3_pt     :=  ? jets.size()>2 ? jets[2].pt : -100 ",
                  "jet3_phi    :=  ? jets.size()>2 ? jets[2].eta : -100 ",
                  "jet3_eta    :=  ? jets.size()>2 ? jets[2].phi : -100 ",
                  ]
