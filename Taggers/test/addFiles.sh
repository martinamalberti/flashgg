MYDIR=~/eos/cms/store/group/phys_higgs/cmshgg/malberti/flashgg/ntuples/vh/vhLepDumper_20170324/
...
hadd -f $MYDIR/Data/output_data.root $MYDIR/Data/DoubleEG*.root
