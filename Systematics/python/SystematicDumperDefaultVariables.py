...
minimalNonSignalVariables = ["CMS_hgg_mass[160,100,180]:=diPhoton().mass", "diphoPt:=diPhoton().pt()"]#,"centralObjectWeight[1,-999999.,999999.] := centralWeight"]
...
systematicVariables=["CMS_hgg_mass[160,100,180]:=diPhoton().mass", "diphoPt:=diPhoton().pt()"]#,"centralObjectWeight[1,-999999.,999999.] := centralWeight"]
